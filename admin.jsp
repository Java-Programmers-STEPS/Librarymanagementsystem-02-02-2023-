								...
								<div class="row">
									<div class="col-sm-6">
										<div class="topbar-info">
											...
											<span>/</span> <a href="mailto:library@gmail.com"><i
												class="fa fa-envelope"></i>support@library.com</a>
										</div>
									</div>
									<div class="col-sm-6">
											...
											<div class="header-cart dropdown">
												...
												<div class="dropdown-menu cart-dropdown">
													...
													<div class="cart-buttons">
														<a href="cart.html" class="btn btn-dark-gray">View
															Cart</a> <a href="checkout.html" class="btn btn-primary">Checkout</a>
													</div>
												</div>
											</div>
										</div>
							...
							<div class="navbar-collapse hidden-sm hidden-xs">
								<ul class="nav navbar-nav">
									<li class="dropdown active"><a data-toggle="dropdown"
										class="dropdown-toggle disabled" href="index-2.html">Home</a>
				...
				<div class="row">
					<div class="col-md-4 col-sm-6 widget-container">
						<div id="text-2" class="widget widget_text">
							...
							<address>
								<div class="info">
									<i class="fa fa-location-arrow"></i> <span>Tkm center for higher learning, 2nd milestone,Kollam,Kerala,India</span>
								</div>
								<div class="info">
