       ...
       function signin()
       {
    	  ...
    	  if(!emailpattern.test(email))
    	   ...
    	   if (!passwordexpression.test(password)){
    		   alert('Upper case, Lower case, Special character and Numeric letter are requirednin password field');
    		   document.getElementById('password').focus();
    		   return false;
    		   }
    	   if(password==''){
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="company-detail bg-dark margin-left">
                                                        ...
                                                        <form class="signin2.jsp" method="post" onsubmit="return signin()">
